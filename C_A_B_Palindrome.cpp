...
{   
    int a, b, q=0;
        ...
        if(s.length()==1){
            if(a==1&&b==0&&(s[0] =='?'||s[0]=='1'))
                cout<<1<<endl;
 
            else if(a==0&&b==1&&(s[0]=='?'||s[0]=='0'))
                cout<<0<<endl;
        ...
        while(left<right){
            if((s[left]=='0'&&s[right]=='1')||(s[left]=='1'&&s[right]=='0')||a<0||b<0){
                flag = false;
                break;
            }
            else if((s[left]=='0'&&s[right]=='?')||(s[left]=='?'&&s[right]=='0')){
                s[right]='0';
                s[left]='0';
                b--;
                q--;
        ...
        right=s.length()-1;
        while(left<right){
            if(s[left]=='?'&&s[right]=='?'&&b>=2){
                s[right]='0';
                s[left]='0';
                b-=2;
                q-=2;
            }
            else if(s[left]=='?'&&s[right]=='?'&&a>=2){
                s[right]='1';
                s[left] ='1';
                a-=2;
                q-=2;
        ...
        if(a==1&&left==right&&s[left]=='?'){
            a--;
            q--;
            s[left] = '1';
        }
        else if(b==1&&left==right&&s[left]=='?'){
            b--;
            q--;
            s[left] = '0';
        }
...
//palindrome t[i]=t[n−i+1] i (1≤i≤n)
